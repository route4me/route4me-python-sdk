...
def main(api_token, connection_token):
    ...
    vendor_connection = telematics.delete_connection(api_token, connection_token)
    telematics.pp_response(vendor_connection)


if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Delete Telematics Member Connection')
