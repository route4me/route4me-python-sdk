...
## Running Get Vendors Example

python3 get_vendors.py --api_key 11111111111111111111111111111111

## Getting Example Help

python3 get_vendors.py -h

usage: get_vendors.py [-h] --api_key API_KEY

Get Telematics Vendors

optional arguments:
  -h, --help         show this help message and exit
  --api_key API_KEY  Route4Me API KEY
