...
class Base(object):
    ...
    def device_timestamp(self, device_timestamp):
        ...
        if is_valid_datetime(device_timestamp):
            ...
            raise ParamValueException(
                "device_timestamp", "Must be YYYY-MM-DD HH:MM:SS format"
            )
    ...
    def optimization_problem_id(self, optimization_problem_id):
        ...
        if self.check_string_type(optimization_problem_id):
            self._copy_param({"optimization_problem_id": optimization_problem_id})
        else:
            raise ParamValueException("optimization_problem_id", "Must be String")
    ...
    def optimized_callback_url(self, optimized_callback_url):
        ...
        if self.check_string_type(optimized_callback_url):
            ...
            raise ParamValueException("optimized_callback_url", "Must be String")
    ...
    def travel_mode(self, travel_mode):
        ...
        if travel_mode in TRAVEL_MODE.reverse_mapping.keys():
            ...
            raise ParamValueException(
                "travel_mode", "Must be DRIVING, " "WALKING, TRUCKING"
            )
    ...
    def optimize(self, optimize):
        ...
        if optimize in OPTIMIZE.reverse_mapping.keys():
            ...
            raise ParamValueException(
                "optimize", "Must be DISTANCE, TIME, " "TIME_WITH_TRAFFIC"
            )
    ...
    def device_type(self, device_type, target="data"):
        ...
        if device_type in DEVICE_TYPE.reverse_mapping.keys():
            ...
            raise ParamValueException(
                "device_type",
                "Must be WEB, IPHONE, " "IPAD, ANDROID_PHONE, " "ANDROID_TABLET",
            )
    ...
    def route_path_output(self, route_path_output):
        ...
        if route_path_output in ROUTE_PATH_OUTPUT.reverse_mapping.keys():
            ...
            raise ParamValueException("route_path_output", "Must be NONE or " "POINTS")
    ...
    def trailer_weight_t(self, trailer_weight_t):
        ...
        if isinstance(trailer_weight_t, int):
            ...
            raise ParamValueException("trailer_weight_t", "Must be integer")
    ...
    def limited_weight_t(self, limited_weight_t):
        ...
        :return:
        """
        if isinstance(limited_weight_t, float) or isinstance(limited_weight_t, int):
            self._copy_data({"limited_weight_t": limited_weight_t})
        else:
            raise ParamValueException("limited_weight_t", "Must be integer")
    ...
    def weight_per_axle_t(self, weight_per_axle_t):
        ...
        :return:
        """
        if isinstance(weight_per_axle_t, float) or isinstance(weight_per_axle_t, int):
            self._copy_data({"weight_per_axle_t": weight_per_axle_t})
        else:
            raise ParamValueException("weight_per_axle_t", "Must be integer")
    ...
    def truck_height(self, truck_height):
        ...
        :return:
        """
        if isinstance(truck_height, float) or isinstance(truck_height, int):
    ...
    def truck_width(self, truck_width):
        ...
        :return:
        """
        if isinstance(truck_width, float) or isinstance(truck_width, int):
    ...
    def truck_length(self, truck_length):
        ...
        :return:
        """
        if isinstance(truck_length, float) or isinstance(truck_length, int):
    ...
    def min_tour_size(self, min_tour_size):
        ...
        if isinstance(min_tour_size, int):
            ...
            raise ParamValueException("min_tour_size", "Must be integer")
    ...
    def route_max_duration(self, route_max_duration):
        ...
        if isinstance(route_max_duration, int):
            ...
            raise ParamValueException("route_max_duration", "Must be integer")
    ...
    def vehicle_capacity(self, vehicle_capacity):
        ...
        if isinstance(vehicle_capacity, int):
            ...
            raise ParamValueException("vehicle_capacity", "Must be integer")
    ...
    def parts(self, parts):
        ...
        if isinstance(parts, int):
            ...
            raise ParamValueException("parts", "Must be integer")
    ...
    def limit(self, limit):
        ...
        if isinstance(limit, int):
            ...
            raise ParamValueException("limit", "Must be integer")
    ...
    def offset(self, offset):
        ...
        if isinstance(offset, int):
            ...
            raise ParamValueException("offset", "Must be integer")
    ...
    def vehicle_max_distance_mi(self, vehicle_max_distance_mi):
        ...
        if isinstance(vehicle_max_distance_mi, int):
            self._copy_data({"vehicle_max_distance_mi": vehicle_max_distance_mi})
        else:
            raise ParamValueException("vehicle_max_distance_mi", "Must be integer")
    ...
    def max_tour_size(self, max_tour_size):
        ...
        if isinstance(max_tour_size, int):
            self._copy_data({"max_tour_size": max_tour_size})
        else:
            raise ParamValueException("max_tour_size", "Must be integer")
    ...
    def uturn(self, uturn_type):
        ...
        if 1 <= uturn_type <= 2:
            ...
            raise ParamValueException(
                "uturn",
                "Must be : " "UTURN_DEPART_SHORTEST or " "UTURN_DEPART_TO_RIGHT",
            )
    ...
    def dirm(self, dirm):
        ...
        if dirm in [1, 3]:
            ...
            raise ParamValueException(
                "dirm",
                "Must be : " "R4M_PROPRIETARY_INTERNAL_NAVIGATION_SYSTEM or" "TRUCKING",
            )
